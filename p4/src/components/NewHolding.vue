        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="table-row" v-if="modeAddConfirm == 'Confirm'">
                <div class="table-cell">
                    ...
                    <label v-else>
                        <router-link
                            :to="{ name: 'research', params: { symbolId: newHolding.symbol } }"
                        >
                            {{
                            newHolding.symbol
                            }}
                ...
                <div class="table-cell">
                    <div class="form-group">
                        <input
                            data-test="input-shares"
                            class="input"
                            required
                            v-model="$v.newHolding.shares.$model"
                        />
                        <div v-if="$v.newHolding.shares.$error">
                            <div
                                class="form-feedback-error"
                                v-if="!$v.newHolding.shares.required"
                            >Number of shares is required</div>
                            <div
                                class="form-feedback-error"
                                v-else-if="!$v.newHolding.shares.numeric"
                            >Must be integer and positive</div>
                            <div
                                class="form-feedback-error"
                                v-else-if="!$v.newHolding.shares.greaterThanOne"
                ...
                <div class="table-cell">
                    <div class="form-group">
                        ...
                        <div v-if="$v.newHolding.cost.$error">
                            <div
                                class="form-feedback-error"
                                v-if="!$v.newHolding.cost.required"
                            >Cost is required</div>
                            <div
                                class="form-feedback-error"
                                v-else-if="!$v.newHolding.cost.positive"
