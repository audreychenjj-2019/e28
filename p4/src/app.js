...
export { default as LocalStorageObject } from "@/LocalStorageObject.js";

export const axios = require("axios");

export const config = {
    stockListUrl:
        "https://financialmodellingprep.com/api/v3/company/stock/list",
    ...
    baseProfileUrl:
        "https://financialmodellingprep.com/api/v3/company/profile/",
